...
function buildVehiclesDisplay($vehicles){
    ...
    foreach ($vehicles as $vehicle) {
     $dv .= '<li>';
     $dv .= "<a href='/phpmotors/vehicles/?action=viewVehicle&invId=$vehicle[invId]'><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a>";
     $dv .= '<hr>';
     $dv .= "<h2><a class=manage href='/phpmotors/vehicles/?action=viewVehicle&invId=$vehicle[invId]'>$vehicle[invMake] $vehicle[invModel]</a></h2>";
